...
void initColors() {
    ...
    if (!initColorsDone) {
        ...
        init_pair(BUTTON_TEXT, COLOR_BUTTON_TEXT_FOREGROUND, COLOR_BUTTON_TEXT_BACKGROUND);
        init_pair(BUTTON_EMPTY, COLOR_BUTTON_EMPTY_FOREGROUND, COLOR_BUTTON_EMPTY_BACKGROUND);
        init_pair(BUTTON_BORDER, COLOR_BUTTON_BORDER_FOREGROUND, COLOR_BUTTON_BORDER_BACKGROUND);
        initColorsDone = 1;
    }
}
