...
#define BLACK_AND_WHITE
    ...
    #define COLOR_BUTTON_TEXT_FOREGROUND   0
    #define COLOR_BUTTON_TEXT_BACKGROUND   255
    #define COLOR_BUTTON_EMPTY_FOREGROUND  255
    #define COLOR_BUTTON_EMPTY_BACKGROUND  255
    #define COLOR_BUTTON_BORDER_FOREGROUND 52
    #define COLOR_BUTTON_BORDER_BACKGROUND 52
    ...
    #define COLOR_BUTTON_TEXT_FOREGROUND   94
    #define COLOR_BUTTON_TEXT_BACKGROUND   144
    #define COLOR_BUTTON_EMPTY_FOREGROUND  144
    #define COLOR_BUTTON_EMPTY_BACKGROUND  144
    #define COLOR_BUTTON_BORDER_FOREGROUND 137
    #define COLOR_BUTTON_BORDER_BACKGROUND 137
#endif
...
#define BUTTON_TEXT   131
#define BUTTON_EMPTY  132
#define BUTTON_BORDER 133
